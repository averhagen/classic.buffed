...
var BuffController = /** @class */ (function () {
    ...
    BuffController.prototype.createBuff = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var buffValues, buffDocument, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("Received buff post request: " + req.url);
                        buffValues = this.extractBuffValuesFromReq(req);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, new buff_1.BuffModel(buffValues)];
                    case 2:
                        buffDocument = _a.sent();
    ...
    BuffController.prototype.extractBuffValuesFromReq = function (req) {
        return {
            name: req.query["name"],
            rank: req.query["rank"]
        };
