...
function startConnectionToTestDB() {
...
exports.startConnectionToTestDB = startConnectionToTestDB;
function stopConnectionToTestDB() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.stopConnectionToTestDB = stopConnectionToTestDB;
function testConnectionIsValid() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
exports.testConnectionIsValid = testConnectionIsValid;
